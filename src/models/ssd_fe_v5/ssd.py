...
class SSD_FE_V5(nn.Module):
    def __init__(self, num_classes):
        super(SSD_FE_V5, self).__init__()
        self.num_classes = num_classes
        # Feature map sizes assuming 512x512 input
        self.feature_maps = [(256, 256), (128, 128), (64, 64)]
        self.scales = [
            [0.015, 0.025],
            [0.035, 0.050],
            [0.070, 0.100],
        ...
        self.heads = nn.ModuleList(
            [
                SSDHead(128, 4, self.num_classes),  # stage1 - conv2_2
                SSDHead(256, 4, self.num_classes),  # stage2 - conv3_3
