...
class SSD_FE_V9(nn.Module):
    def __init__(self, num_classes):
        super(SSD_FE_V9, self).__init__()
        self.num_classes = num_classes
        # Feature map sizes assuming 512x512 input
        self.feature_maps = [(256, 256), (256, 256), (128, 128), (128, 128), (128, 128)]
        self.scales = [
            [0.010, 0.015],
            [0.015, 0.025],
            [0.025, 0.035],
        ...
        self.heads = nn.ModuleList(
            [
                ...
                SSDHead(256, 4, self.num_classes),  # stage3 - conv3_1
                SSDHead(256, 4, self.num_classes),  # stage4 - conv3_2
                SSDHead(256, 4, self.num_classes),  # stage5 - conv3_3
            ]
        )
