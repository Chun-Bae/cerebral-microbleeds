...
class SSD_FE_V6(nn.Module):
    def __init__(self, num_classes):
        super(SSD_FE_V6, self).__init__()
        self.num_classes = num_classes
        # Feature map sizes assuming 512x512 input
        self.feature_maps = [(256, 256), (128, 128), (128, 128)]
        self.scales = [
            [0.015, 0.025],
            [0.035, 0.050],
            [0.070, 0.100],
        ...
        self.heads = nn.ModuleList(
            [
                ...
                SSDHead(256, 4, self.num_classes),  # stage2 - conv3_1
    ...
    def forward(self, x, gt_image=None, gt_mask=None):
        ...
        # Stage 3: conv3_3
        # 12 (conv3_2) ~ 15 (ReLU3_3)
        x = self.vgg16[12:16](x)
